											...
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														<p class="fs-14 mb-2">Jumlah Aset</p>

														<p><?php echo e($jumlahAset); ?></p>
											...
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														...
														<p><?php echo e($jumlahLakiLaki); ?>/ <?php echo e($jumlahPerempuan); ?></p>
													</div>
												</div>
												<div class="progress" style="height:5px;">
										...
										<div class="card avtivity-card">
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														<p class="fs-14 mb-2">Total Pembeli</p>
														<p><?php echo e($jumlahPembeli); ?></p>
													</div>
												</div>
												<div class="progress" style="height:5px;">
									...
									<div class="col-12">
										<div class="table-responsive">
											<table class="table table-bordered">
												<thead>
													<tr>
														<th>Dokumen Pembeli Aset</th>
														<th width="10" class="text-center">Jumlah</th>
													</tr>
												</thead>
												<tbody>
													<?php $__currentLoopData = $aset; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr>
														<td><?php echo e($aset->nama_aset); ?></td>
														<td><?php echo e($aset->pembeli_count); ?></td>
													</tr>
									...
									<div class="col-lg-12">
										<div class="card bg-gra"
											...
											<div class="card-body">
												...
												<div class="mt-4">
													<h5 class="mb-0" style="color: #008eff">Selamat Datang, ARYA QADHAFY</h5>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="card">
											<div class="card-body">
												...
												<ul
													...
													<li class="mb-2"><span class="fs-14 text-black font-w500">2024-12-09
															11:07:38</span>
													</li>
												</ul>
												<ul
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\finalprojectwebdavi\resources\views/dashboard.blade.php ENDPATH**/ ?>